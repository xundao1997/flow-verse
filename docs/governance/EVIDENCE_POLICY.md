...
| PostgreSQL is the only bootstrap data service; object storage remains an S3-compatible contract with no provider/runtime selected | Approved architecture decision | Confirmed | User approval, 2026-07-14 and service-boundary confirmation 2026-07-15; `../decisions/ADR-0002-service-directory-topology.md` | Business schema, retention implementation, storage provider and deployment remain deferred | User |
